...
The source code of cclib 1.3b is distributed as:
 * A .zip file: https://github.com/cclib/cclib/releases/download/v1.3b/cclib-1.3b.zip
 * A .tar.gz file: https://github.com/cclib/cclib/releases/download/v1.3b/cclib-1.3b.tar.gz
 * Windows binary installers (see the `1.3b release page`_)
...
None of these files include the tests and logfiles used for testing. In order to download all tests, we also provide source archives on the `1.3b release page`_.
...
.. _`1.3b release page`: https://github.com/cclib/cclib/releases/tag/v1.3b
