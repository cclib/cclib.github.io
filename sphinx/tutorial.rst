...
The source code of cclib 1.2 is distributed as:
 * A .zip file: https://github.com/cclib/cclib/releases/download/v1.2/cclib-1.2.zip
 * A .tar.gz file:  https://github.com/cclib/cclib/releases/download/v1.2/cclib-1.2.tar.gz
 * A Windows binary installer: https://github.com/cclib/cclib/releases/download/v1.2/cclib-1.2.win32.exe
...
None of these files include the tests and logfiles used for testing. In order to download all tests, we also provide source archives on the `1.2 release page`_.
...
.. _`1.2 release page`: https://github.com/cclib/cclib/releases/tag/v1.2
